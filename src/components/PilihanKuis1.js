            ...
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/aksaranglegena/kuis1/nggolekitembangnglegena"
          ...
          <Col md={4} className="categoryWrapper" id="categories">
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/aksaranglegena/kuis1/ngaturukaranglegena"
                    class="btn btn-custom"
                  >
                    Mulai
                  </a>
          ...
          <Col md={4} className="categoryWrapper" id="categories">
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/aksaranglegena/kuis1/utakatikgathuknglegena"
                    class="btn btn-custom"
                  >
                    Mulai
                  </a>
          ...
          <Col md={4} className="categoryWrapper" id="categories">
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/aksaranglegena/kuis1/nyocokakegambarnglegena"
                    class="btn btn-custom"
                  >
                    Mulai
                  </a>
          ...
          <Col md={4} className="categoryWrapper">
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/aksaranglegena/kuis1/nyocokakeswara"
                    class="btn btn-custom"
                  >
                    Mulai
                  </a>
