            ...
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/pasanganaksaranglegena/kuis2/nggolekitembangpasangannglegena"
          ...
          <Col md={4} className="categoryWrapper" id="categories">
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/pasanganaksaranglegena/kuis2/ngaturukarapasangannglegena"
                    class="btn btn-custom"
                  >
                    Mulai
                  </a>
          ...
          <Col md={4} className="categoryWrapper" id="categories">
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/pasanganaksaranglegena/kuis2/nyocokakegambarpasangannglegena"
                    class="btn btn-custom"
                  >
                    Mulai
                  </a>
          ...
          <Col md={4} className="categoryWrapper">
            <Card className="modeImage">
              ...
              <div>
                ...
                <div className="text-center">
                  <a
                    href="/pasanganaksaranglegena/kuis2/nyocokakeswara"
                    class="btn btn-custom"
                  >
                    Mulai
                  </a>
